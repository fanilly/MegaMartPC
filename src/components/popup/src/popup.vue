<template>
    <div>
        <mj-mask v-model="show" @click.native="close" :opacity="maskerOpacity"></mj-mask>
...
<script type="text/babel">
    import {preventScroll} from '../../../utils/Assist.js';
    ...
    export default {
        ...
        computed: {
            classes() {
                return (this.position === 'center' ? 'mj-popup-center ' : 'mj-popup mj-popup-' + this.position) +
                        (this.show ? ' mj-popup-show ' : '');
            },
            styles() {
